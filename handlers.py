...
2. Игровое поле: Игровое поле состоит из пяти строк, в каждой из которых показано, были ли угаданные буквы на своем месте (зеленый цвет), присутствуют ли угаданные буквы, но на другом месте (желтый цвет), или вообще нет угаданных букв (серый цвет).

3. Количество попыток: У игрока есть шесть попыток, чтобы угадать слово.
...
5. Конец игры: Игра заканчивается, когда игрок угадывает слово или когда он исчерпывает все шесть попыток.
